...
class CommandCompleter(Completer):
    ...
    def __init__(self) -> None:
        ...
        self.COMMANDS = my_commands.COMMANDS
    ...
    def find_completions(self, document: Document) -> dict:
        ...
        tokens = [token for token in self.get_tokens(document.text) if not token.startswith('--')]
        ...
        flags = [flag for flag in self.get_tokens(document.text) if flag.startswith('--')]
